...
from lwotai import Posture
from lwotai import random_roll
...
class Scenarios(unittest.TestCase):
  ...
  def test_scenario_setup(self) :
    ...
    self.assertEqual(app.board.funding_track.funding(), 5)
    self.assertEqual(app.board.funding_track.available_cells(), 2)
    self.assertEqual(app.board.world["Libya"].governance, Governance.POOR)
    self.assertEqual(app.board.world["Libya"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.board.world["Syria"].governance, Governance.FAIR)
    self.assertEqual(app.board.world["Syria"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.board.world["Iraq"].governance, Governance.POOR)
    self.assertEqual(app.board.world["Iraq"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.board.world["Iraq"].plots, 2)
    self.assertEqual(app.board.world["Saudi Arabia"].governance, Governance.POOR)
    self.assertEqual(app.board.world["Saudi Arabia"].alignment, Alignment.ALLY)
    self.assertEqual(app.board.world["Saudi Arabia"].troops_stationed, 2)
    self.assertEqual(app.board.world["Pakistan"].governance, Governance.FAIR)
    self.assertEqual(app.board.world["Pakistan"].alignment, Alignment.NEUTRAL)
    self.assertEqual(app.board.world["Pakistan"].troops_stationed, 2)
    self.assertEqual(app.board.world["Pakistan"].active_cells, 4)
    self.assertEqual(app.board.world["Gulf States"].governance, Governance.FAIR)
    self.assertEqual(app.board.world["Gulf States"].alignment, Alignment.ALLY)
    self.assertEqual(app.board.world["Gulf States"].troops_stationed, 4)
    self.assertEqual(app.board.world["Gulf States"].sleeper_cells, 1)
    self.assertEqual(app.board.world["Gulf States"].active_cells, 4)
    self.assertEqual(app.board.world["Afghanistan"].governance, Governance.ISLAMIST_RULE)
    self.assertEqual(app.board.world["Afghanistan"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.board.world["Afghanistan"].sleeper_cells, 4)
    self.assertEqual(app.board.world["Somalia"].besieged, 1)
    self.assertEqual(app.board.world["United States"].posture, Posture.HARD)
...
class Board(unittest.TestCase):
  ...
  def test_adjacency(self) :
    ...
    for country in app.board.world:
      for link in app.board.world[country].links:
        self.assertTrue(app.board.world[country] in link.links)

  def test_random_roll(self) :
    for x in range(0, 20) :
      res = random_roll()
      self.assertEqual(type(res), type(int()))
...
class deploy(unittest.TestCase) :
  ...
  def test_deploy(self) :
    ...
    self.assertEqual(app.map["Gulf States"].troops(), 4)
    res = app.deploy("Saudi Arabia", 2, "Gulf States")
    self.assertTrue(res[0])
    self.assertEqual(app.map["Saudi Arabia"].troops(), 4)
    self.assertEqual(app.map["Gulf States"].troops(), 2)
  ...
  def test_not_enough(self) :
    ...
    self.assertEqual(app.map["Saudi Arabia"].troops(), 2)
    self.assertEqual(app.map["Gulf States"].troops(), 4)
    res = app.deploy("Saudi Arabia", 6, "Gulf States")
    self.assertFalse(res[0])
    self.assertEqual(res[2], 'not_enough')
    self.assertEqual(app.map["Saudi Arabia"].troops(), 2)
    self.assertEqual(app.map["Gulf States"].troops(), 4)

  def test_not_enough_troop_track(self) :
    app = Labyrinth(TEST_SCENARIO, 1)
    self.assertEqual(app.map["Saudi Arabia"].governance, Governance.POOR)
    self.assertEqual(app.map["Saudi Arabia"].alignment, Alignment.ALLY)
    self.assertEqual(app.map["Saudi Arabia"].troops(), 2)
    self.assertEqual(app.board.troop_track.troops(), 7)
    res = app.deploy("Saudi Arabia", 8, "troop_track")
    self.assertFalse(res[0])
    self.assertEqual(res[2], 'not_enough')
    self.assertEqual(app.map["Saudi Arabia"].troops(), 2)
    self.assertEqual(app.board.troop_track.troops(), 7)
  ...
  def test_not_allied(self) :
    for a in [Alignment.NEUTRAL, Alignment.ADVERSARY] :
      app = Labyrinth(TEST_SCENARIO, 1)
      app.board.set_alignment("Saudi Arabia", a)
      self.assertEqual(app.board.country("Saudi Arabia").alignment, a)
      res = app.deploy("Saudi Arabia", 2, "Gulf States")
      self.assertFalse(res[0])
      self.assertEqual(res[2], 'not_allied')
      self.assertEqual(app.map["Saudi Arabia"].troops(), 2)
      self.assertEqual(app.map["Gulf States"].troops(), 4)
...
class regime_change(unittest.TestCase):
  ...
  def test_regime_change_troop_track(self) :
    ...
    self.assertNotEqual(app.map["Afghanistan"].governance, Governance.ISLAMIST_RULE)
    self.assertEqual(app.map["Afghanistan"].alignment, Alignment.ALLY)
    self.assertEqual(app.map["Afghanistan"].troops_stationed, 6)
    self.assertEqual(app.map["Afghanistan"].sleeper_cells, 0)
    self.assertEqual(app.map["Afghanistan"].active_cells, 4)
    self.assertEqual(app.map["Afghanistan"].regime_change, 1)
  ...
  def test_already_regime_change(self) :
    ...
    res = app.regime_change("Afghanistan", 6, "troop_track")
    self.assertEqual(res[0], False)
    self.assertEqual(res[4], 'already_regime_change')
    self.assertEqual(app.map["Afghanistan"].governance, governance)
    self.assertEqual(app.map["Afghanistan"].alignment, Alignment.ALLY)
    self.assertEqual(app.map["Afghanistan"].troops_stationed, 6)
    self.assertEqual(app.map["Afghanistan"].sleeper_cells, 0)
    self.assertEqual(app.map["Afghanistan"].active_cells, 4)
  ...
  def test_min_troops(self) :
    ...
    self.assertEqual(app.board.prestige_track.get_prestige(), 7)
    self.assertEqual(app.board.troop_track.get_troops(), 7)
    res = app.regime_change("Afghanistan", 5, "troop_track")
    self.assertEqual(res[0], False)
    self.assertEqual(res[4], 'min_troops')
    self.assertEqual(app.map["Afghanistan"].governance, Governance.ISLAMIST_RULE)
    self.assertEqual(app.map["Afghanistan"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.map["Afghanistan"].troops_stationed, 0)
    self.assertEqual(app.map["Afghanistan"].sleeper_cells, 4)
  ...
  def test_not_islamist_rule(self) :
    ...
    res = app.regime_change("Afghanistan", 6, "troop_track")
    self.assertEqual(res[0], False)
    self.assertEqual(res[4], 'not_islamist_rule')
    self.assertEqual(app.map["Afghanistan"].governance, Governance.POOR)
    self.assertEqual(app.map["Afghanistan"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.map["Afghanistan"].troops_stationed, 0)
    self.assertEqual(app.map["Afghanistan"].sleeper_cells, 4)
  ...
  def test_regime_change_troop_restriction(self) :
    ...
    app.board.world["Pakistan"].regime_change = 1
    self.assertEqual(app.map["Afghanistan"].governance, Governance.ISLAMIST_RULE)
    self.assertEqual(app.map["Afghanistan"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.map["Afghanistan"].troops_stationed, 0)
    self.assertEqual(app.map["Afghanistan"].sleeper_cells, 4)
    ...
    res = app.regime_change("Afghanistan", 6, "Pakistan")
    self.assertEqual(res[0], False)
    self.assertEqual(res[2], 'regime_change_troop_restriction')
    self.assertEqual(app.map["Afghanistan"].governance, Governance.ISLAMIST_RULE)
    self.assertEqual(app.map["Afghanistan"].alignment, Alignment.ADVERSARY)
  ...
  def test_regime_change(self) :
    ...
    self.assertEqual(app.board.troop_track.get_troops(), 3)
    self.assertEqual(app.map["Pakistan"].troops_stationed, 10)
    res = app.regime_change("Afghanistan", 7, "Pakistan")
    self.assertEqual(res[0], True)
    self.assertNotEqual(app.map["Afghanistan"].governance, Governance.ISLAMIST_RULE)
    self.assertNotEqual(app.map["Afghanistan"].alignment, Alignment.ADVERSARY)
    self.assertEqual(app.map["Afghanistan"].troops_stationed, 7)
    self.assertEqual(app.map["Afghanistan"].sleeper_cells, 0)
    self.assertEqual(app.map["Afghanistan"].active_cells, 4)
    self.assertEqual(app.map["Afghanistan"].regime_change, 1)
    self.assertNotEqual(app.board.prestige_track.get_prestige(), 7)
...
class withdraw(unittest.TestCase):
  ...
  def test_not_allied(self) :
    for a in [Alignment.NEUTRAL,Alignment.ADVERSARY] :
      ...
      self.assertEqual(app.map["Afghanistan"].besieged, 0)
      self.assertEqual(app.map["Saudi Arabia"].troops_stationed, 2)
      self.assertEqual(app.map["Saudi Arabia"].alignment, a)
      self.assertEqual(app.board.prestige_track.get_prestige(), 7)
      self.assertEqual(app.board.troop_track.get_troops(), 1)
      res = app.withdraw("Saudi Arabia", 4, "Afghanistan")
      self.assertEqual(res[0], False)
...
#    app = Labyrinth(TEST_SCENARIO, 1, testScenarioSetup)
...
#    app.map["Gulf States"].regimeChange = 1
#    app.map["Gulf States"].aid = 1
#    app.executeJihad("Gulf States", [3,4,4]) # Revolution succeeds
#    self.assertEqual(app.map["Gulf States"].governance, 4) # gov still 3
#    self.assertEqual(app.map["Gulf States"].sleeperCells, 0) # all cells active
#    self.assertEqual(app.map["Gulf States"].activeCells, 7) # lost two cells to the to failure rolls
#    self.assertEqual(app.map["Gulf States"].regimeChange, 0) 
#    self.assertEqual(app.map["Gulf States"].aid, 0) 
#    self.assertEqual(app.map["Gulf States"].besieged, 0) # need three fails to get a besieged regime
#    self.assertEqual(app.map["Gulf States"].alignment, "Adversary") 
#    self.assertEqual(app.funding, 8)
...
#
#    app = Labyrinth(TEST_SCENARIO, 1, test3ScenarioSetup)
...
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup)
...
#
#  # Attractive
#    app = Labyrinth(TEST_SCENARIO, 2, testBlankScenarioSetup)
#    app.cells = 15
#    unusedOps = app.executeRecruit("United States", 1, [1])
#    self.assertEqual(unusedOps, 0)
#    self.assertEqual(app.map["United States"].sleeperCells, 2)
...
#
#    app = Labyrinth(TEST_SCENARIO, "WMD", testBlankScenarioSetup)
#    app.map["Germany"].plots = 1
#    app.resolvePlot("Germany", 1, 4, [], ["Spain", "Scandinavia"], [5,4], [])
#    self.assertEqual(app.funding, 7)
#    self.assertEqual(app.map["Germany"].posture, "Soft")
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ['y'])
...
#
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Saudi Arabi", "Spain","h"])
#    app.map["Spain"].posture = "Soft"
#    app.map["Saudi Arabia"].governance = 1
#    app.map["Saudi Arabia"].plots = 1
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Iraq"])
#    app.map["Iraq"].sleeperCells = 2
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["6"])
#    app.map["United States"].posture = "Hard"
#    app.map["Spain"].posture = "Soft"
...
#
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Iraq", "6"])
#    app.map["United States"].posture = "Hard"
#    app.map["Spain"].posture = "Soft"
#    app.map["France"].posture = "Soft"
#    app.map["Germany"].posture = "Soft"
...
#
#  def testPlayable(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["y","n"])
#    app.map["United States"].posture = "Hard"
...
#  
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["y","y","Pakistan"])
#    app.map["United States"].posture = "Soft"
#    app.map["Iraq"].governance = 3
#    app.map["Iraq"].alignment = "Adversary"
#    app.map["Pakistan"].governance = 4
...
#
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["n", "n"])
#    app.map["United States"].posture = "Soft"
#    app.map["Iraq"].governance = 3
#    app.map["Iraq"].alignment = "Adversary"
#    app.map["Pakistan"].governance = 4
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["h"])
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["s","1"])
#    app.map["Pakistan"].governance = 2
#    app.map["Pakistan"].alignment = "Adversary"
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup,["france", "s", "Spain", "h"])
#    app.map["Libya"].governance = 3
#    app.map["Iraq"].alignment = "Ally"
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Libya", "track", "3"])
#    app.map["Libya"].governance = 3
#    app.map["Libya"].alignment = "Ally"
#    app.map["Libya"].regimeChange = 1
...
#    self.assertTrue(app.map["Iraq"].cadre == 0)
#
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Pakistan"])
#    app.map["Iraq"].cadre = 1
#    app.map["Iraq"].governance = 3
#    app.map["Iraq"].alignment = "Neutral"
#    app.map["Iraq"].troopCubes = 2
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["4", "Spain", "h"])
...
#    self.assertTrue(app.map["Iraq"].governance == 1)
#
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Lebanon"])
#    app.map["Iraq"].governance = 2
#    app.map["Iraq"].alignment = "Ally"
#    app.map["Iraq"].regimeChange = 1
#    app.map["Iraq"].sleeperCells = 1
...
#
#  def testPlayable(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["n","y"])
#    print("Say No")
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testScenarioSetup, ["1"])
...
#
#  def testEvent(self):
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup,["s","h"])
...
#    self.assertTrue(app.map["Iraq"].sleeperCells == 0)
#
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Yemen"])
#    app.testCountry("Iraq")
#    app.map["Iraq"].sleeperCells = 1
#    app.testCountry("Yemen")
...
#  
#    app = Labyrinth(TEST_SCENARIO, 1, testBlankScenarioSetup, ["Indonesia/Malaysia"])
#    app.testCountry("Indonesia/Malaysia")
#    app.map["Indonesia/Malaysia"].sleeperCells = 1
#    app.map["Indonesia/Malaysia"].alignment = "Ally"
#    app.testCountry("Philippines")
